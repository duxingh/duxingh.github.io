...
last_modified_at: 2026-06-17 16:36:34 +0800
---
...
2. **开仓**（日线）
   - 在牛市中，当 SuperTrend 由红翻绿时，以限价（可以取 10 分钟内的最低价）开仓。
   - 在熊市中，当 SuperTrend 由绿翻红时，以限价（可以取 10 分钟内的最高价）开仓。
3. **加仓**
   - 如果趋势仍在，当价格回踩 EMA20 或 EMA60 后又重新站稳时，可以限价加仓。
   - 最多三次加仓。
4. **止损**
